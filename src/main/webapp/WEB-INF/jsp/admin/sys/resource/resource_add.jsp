...
<title>HeMaozhu-管理系统-添加菜单</title>
					...
					<div class="ibox-content">
						<form id="addForm" class="form-horizontal" onsubmit="return false">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="permission" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4">资源类型：</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input name="icon" class="form-control icp icp-auto"
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="orderNum" class="form-control" autocomplete="off">
								</div>
							</div>
