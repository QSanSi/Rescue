...
<title>HeMaozhu-管理系统-角色管理</title>
...
<body class="gray-bg">
	...
	function addFunctionAlty(value, data, index) {
		var id = data.roleId;
		var result = "";
		result += "<button id='assign-resource' class='btn btn-primary' onclick=\"assign('"
				+ id
				+ "')\"><i class='fa fa-cube'></i> 分配资源</button>&nbsp;&nbsp;";
	...
	function assign(id) {
		var title = "分配资源";
		var url = "${ctx}/sys/role/assign/resource/" + id;
		layer.open({
			type : 2,
			title : title,
			shadeClose : true,
