				...
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						<form class="form-horizontal m-t" onsubmit="return false" id="Form" enctype="multipart/form-data">
							<input type="hidden" value="${tips.tipsId}" name="tipsId">
							<div class="form-group">
								<label class="col-sm-1 control-label">标题：</label>
								<div class="col-sm-5">
									<input id="title" name="title" type="text" class="form-control"
										autocomplete="off" value="${tips.title}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-1 control-label">介绍：</label>
								<div class="col-sm-5">
									<textarea class="form-control" name="introduction" id="introduction">${tips.introduction}</textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input id="tag" name="tag" type="text" class="form-control"
										autocomplete="off" value="${tips.tag}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-1 control-label">内容：</label>
								<div class="col-sm-11">
									<textarea class="summernote" name="content" id="summernote">${tips.content}</textarea>
								</div>
							</div>
...
                data: data,
                type: "POST",
                url: "${ctx}/admin/tips/upload", //图片上传出来的url，返回的是图片上传后的路径，http格式
                contentType: false,
                cache: false,
                processData: false,
                success: function (response) {
