						...
						<form class="form-horizontal m-t" onsubmit="return false" id="Form" enctype="multipart/form-data">
							...
							<div class="form-group" id="data_1">
								...
								<div class="input-group date" id="datepicker" style="padding-left: 15px;width: 160px;">
                                	...
                                	<input id="birthday" name="birthday" type="text" class="form-control"  autocomplete="off" value="${pet.birthday}">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea id="remark" name="remark" class="form-control">${pet.remark}</textarea>
								</div>
							</div>
