				...
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						<form class="form-horizontal m-t" onsubmit="return false" id="Form" enctype="multipart/form-data">
							<input id="deptId" type="hidden" value="${con.deptId}" name="deptId">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input id="master" name="master" type="text" class="form-control"
										autocomplete="off" value="${con.master}">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input id="age" type="text" class="form-control"
										name="age" autocomplete="off" value="${con.age}">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input id="career" name="career" type="text" class="form-control"
										autocomplete="off" value="${con.career}">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input id="tel" name="tel" type="tel" class="form-control"
										autocomplete="off" value="${con.tel}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">居住地址： </label>
								<div class="col-sm-5">
									<textarea id="addr" name="addr" class="form-control">${con.addr}</textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input id="idcard" type="text" class="form-control"
										name="idcard" autocomplete="off" value="${con.idcard}">
								</div>
							</div>
							<div class="form-group">
