            ...
            3: function (t, e, n) {
                ...
                function it(t, e) {
                    ...
                    if (0 === t.offset) {
                        ...
                        ot(t.node) ? o = W(n = t.node.childNodes[t.offset - 1]) : (n = t.node, o = e ? 0 : t.offset - 1);
                    return {
                        node: n,
                        offset: o
                    }
                ...
                var mt = function () {
                    ...
                    (n = [{
                                ...
                                value: function (t) {
                                    ...
                                    e.shouldInitialize() && (e.initialize && e.initialize(), e.events && ft.attachEvents(this.$note, e.events))
                                }
                            }, {
                                key: "module",
                ...
                function gt(t, e) {
                    ...
                    if (0 !== n && ft.isText(a[n - 1])) {
                        ...
                        l.nodeValue;
                        e && l.nextSibling && ft.isText(l.nextSibling) && u === l.nodeValue.length && (u -= l.nodeValue.length, l = l.nextSibling),
                        i = l,
                        n = u
                    }
                    return {
                    ...
                    (n = [{
                                ...
                                value: function () {
                                    if (ft.isBodyContainer(this.sc) && ft.isEmpty(this.sc))
                                        return this.sc.innerHTML = ft.emptyPara, new t(this.sc.firstChild, 0, this.sc.firstChild, 0);
                                    var e,
                                    n = this.normalize();
                ...
                kt = {
                    ...
                    createFromNode: function (t) {
                        ...
                        o = t,
                        i = ft.nodeLength(o);
                        return ft.isVoid(e) && (n = ft.listPrev(e).length - 1, e = e.parentNode),
                    ...
                    (n = [{
                                ...
                                value: function () {
                                    ...
                                    this.documentEventHandlers.onDragenter = function (o) {
                                        ...
                                        i || e.length || !r || (t.$editor.addClass("dragover"), t.$dropzone.width(t.$editor.width()), t.$dropzone.height(t.$editor.height()), n.text(t.lang.image.dragImageHere)),
                                        e = e.add(o.target)
                                    },
                                    ...
                                    this.$dropzone.on("drop", (function (e) {
                                            ...
                                            e.preventDefault(),
                                            n && n.files && n.files.length ? (t.$editable.focus(), t.context.invoke("editor.insertImagesOrCallback", n.files)) : i.a.each(n.types, (function (e, o) {
                ...
                var Vt = function () {
                    ...
                    (n = [{
                                ...
                                value: function () {
                                    ...
                                    this.isFullscreen() ? (this.$editable.data("orgHeight", this.$editable.css("height")), this.$editable.data("orgMaxHeight", this.$editable.css("maxHeight")), this.$editable.css("maxHeight", ""), this.$window.on("resize", this.onResize).trigger("resize"), this.$scrollbar.css("overflow", "hidden")) : (this.$window.off("resize", this.onResize), this.resizeTo({
                                ...
                                value: function () {
                                    if (this.lastWord) {
                                        ...
                                        this.options.match(e, (function (e) {
                                                if (e) {
                                                    var n = "";
                                                    if ("string" == typeof e ? n = ft.createText(e) : e instanceof jQuery ? n = e[0] : e instanceof Node && (n = e), !n)
                                                        return;
                    ...
                    (n = [{
                                ...
                                value: function () {
									...
									this.context.memo("button.floatCenter", (function () {
                                            return t.button({
                                                contents: t.ui.icon(t.options.icons.alignCenter),
                                                tooltip: t.lang.image.floatCenter,
                                                click: t.context.createInvokeHandler("editor.floatMe", "center")
                                            }).render()
                                        })),
                    ...
                    function t(e) {
                        ...
                        this.events = {
                            ...
                            "summernote.keyup summernote.mouseup summernote.scroll": function (t, e) {
                                n.options.editing && !n.onContextmenu && (n.pageX = e.pageX, n.pageY = e.pageY, n.update()),
                                n.onContextmenu = !1
                            },
...
function deleteImg(src){
	var ctx = getRootPath();
	src = src.substr(ctx.length);
    var url = ctx + "/filecontrol/delete";
